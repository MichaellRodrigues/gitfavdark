...
export class FavoritesView extends Favorites {
  ...
  createRow() {
    ...
    <div class="user">
      <img
        src="https://github.com/michaellrodrigues.png"
        alt="Imagem de Michaell"
      />
      <a href="https://github.com/michaellrodrigues.com" target="_blank">
        <p>Michaell</p>
        <span>michaellrodrigues</span>
      </a>
    </div>
  </td>
